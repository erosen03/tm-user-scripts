...
function getCredentials(){
    ...
    // format is:
    //  "{%aws-account-id%}_{%permission-set-name%}": "the_profile_name_you_want"
    // example
    // var credentialProfileFriendlyNames = {
    //    "012345678901_AWS_Administrator": "MasterAccount_Admin"
    //    "012345678901_AWS_Auditor": "MasterAccount_Auditor"
    //    "567890101234_AWS_Reader": "LogAccount_Reader"
    // };
    var credentialProfileFriendlyNames = {
    };
    ...
    var credentialProfilePrefix = "";

    // use account name instead of account number in profile definitions
    var useAccountNameInsteadOfNumber = true;

    // mapping between account numbers and names
